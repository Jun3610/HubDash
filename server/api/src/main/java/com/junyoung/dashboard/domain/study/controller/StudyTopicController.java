...
public class StudyTopicController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<StudyTopicResponse>> findAll(@PageableDefault(size = 20) Pageable pageable) {
        return ApiResponse.success(PageResponse.of(studyTopicService.findAll(pageable)));
    }
