...
public class HabitController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<HabitResponse>> findAll(@PageableDefault(size = 20) Pageable pageable) {
        return ApiResponse.success(PageResponse.of(habitService.findAll(pageable)));
    }
