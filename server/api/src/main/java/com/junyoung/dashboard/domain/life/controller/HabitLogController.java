...
public class HabitLogController {
    ...
    @GetMapping
    public ApiResponse<PageResponse<HabitLogResponse>> findByHabitId(
            @RequestParam Long habitId, @PageableDefault(size = 20) Pageable pageable) {
        return ApiResponse.success(PageResponse.of(habitLogService.findByHabitId(habitId, pageable)));
    }
